...
class Portfolio:
    ...
    # Пример:
    # Пришло: stocks = {"AAPL": 10, "GOOGL": 5, "MSFT": 8}  prices = {"AAPL": 155.25, "GOOGL": 2600.75, "MSFT": 800.50}
    # Вышло: MSFT
    def get_most_profitable_stock(stocks: dict, prices: dict) -> str:
        temp_dit = {k1: round((v * 100 / v1)) for k, v in prices.items() for k1, v1 in last.items() if k == k1}
